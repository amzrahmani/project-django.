...
all_posts = [
    {
        ...
        'title': 'django course',
        'author': 'zeynab rahmani',
        'image': 'django.png',
        'date': date(2021, 4, 5),
        'short_description': 'this is django course in django from zero to hero',
        'content': """
    ...
    },
    {
        ...
        'image': 'python.png',
        'date': date(2021, 6, 3),
        'short_description': 'this is django course in leraen django from zero to hero',
        'content': """
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aliquid dicta, eius eos eum eveniet
